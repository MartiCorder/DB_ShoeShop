...
import cat.uvic.teknos.shoeshop.cryptoutils.exeptions.CryptoException;
...
public class CryptoUtils {
    ...
    public static String asymmetricEncrypt(String plainText, Key publicKey) {
        try {
    ...
    public static String asymmetricDecrypt(String encryptedTextBase64, Key privateKey) {
        try {
            var cipher = Cipher.getInstance("RSA");
